...
<html>
	<head>
		...
		<title>Registration : RFID-Enhanced Queue System for Appointment Scheduling. </title>
	</head>
			...
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
				...
				<form class="form-horizontal" action="insertDB.php" method="post" >
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="Age" type="number" min="0" placeholder="" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="Number" type="Number" min="0" placeholder="" required>
						</div>
					</div>					
